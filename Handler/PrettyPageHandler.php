...
use IntelliSense\Exception\Formatter;
use IntelliSense\Util\Misc;
use IntelliSense\Util\TemplateHelper;
...
class PrettyPageHandler extends Handler
{
     ...
     * @var string
     */
    private $pageTitle = "IntelliSense! There was an error.";
    ...
    public function handle()
    {
        if (!$this->handleUnconditionally()) {
            ...
            if (PHP_SAPI === 'cli') {
                ...
                if (isset($_ENV['IntelliSense-test'])) {
                    throw new \Exception(
                        'Use handleUnconditionally instead of IntelliSense-test'
        ...
        $cssFile      = $this->getResource("css/IntelliSense.base.css");
        $zeptoFile    = $this->getResource("js/zepto.min.js");
        $prettifyFile = $this->getResource("js/prettify.min.js");
        $clipboard    = $this->getResource("js/clipboard.min.js");
        $jsFile       = $this->getResource("js/IntelliSense.base.js");
     ...
     *
     * @return \IntelliSense\Exception\FrameCollection;
     */
    ...
    public function addDataTableCallback($label, /* callable */ $callback)
    {
        ...
        $this->extraTables[$label] = function (\IntelliSense\Exception\Inspector $inspector = null) use ($callback) {
            try {
