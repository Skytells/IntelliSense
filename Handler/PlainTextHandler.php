...
use IntelliSense\Exception\Frame;

/**
* Handler outputing plaintext error messages. Can be used
* directly, or will be instantiated automagically by IntelliSense\Run
...
class PlainTextHandler extends Handler
{
     ...
     * @param  \IntelliSense\Exception\Frame $frame [description]
